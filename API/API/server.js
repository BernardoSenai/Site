...
const FRONTEND_URL = process.env.FRONTEND_URL || "https://site-kxis.onrender.com/" || "http://localhost:5500"; // Substitua pela URL do seu frontend.
...
const cardapio = [
  { categoria: "pao", nome: "Tradicional", preco: 1.5 },
